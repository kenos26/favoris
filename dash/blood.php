    ...
    <div class="uk-modal-dialog uk-modal-body">
      ...
      <option >Hubli</option>
       ...
       <option >Gadag</option>
        ...
        <?php
        $query1=mysql_query("select * from register");
echo "<table class='uk-table uk-table-striped'><tr><td>ID</td><td>First Name</td><td>Last Name</td><td>Age</td><td>Blood Group</td><td>Phone</td><td>Address</td><td>Image</td><td>City</td><td>EDIT</td><td>DELETE</td>";
while($query2=mysql_fetch_array($query1))
{
echo "<tr><td>".$query2['register_id']."</td>";
echo "<td>".$query2['firstname']."</td>";
echo "<td>".$query2['lastname']."</td>";
echo "<td>".$query2['age']."</td>";
echo "<td>".$query2['bloodgroup']."</td>";
...
echo "<td><a href='editblood.php?id=".$query2['register_id']."'><span  class='uk-icon-button' uk-icon='icon: file-edit' style='color:#0090C1;'></span></a></td>";
echo "<td><a href='deleteblood.php?id=".$query2['register_id']."'><span  class='uk-icon-button' uk-icon='icon: trash' style='color:#E63462;'></span></a></td><tr>";
}
?>
</ol>
</table>
